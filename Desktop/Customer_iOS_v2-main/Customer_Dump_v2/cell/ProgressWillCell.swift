...
class ProgressWillCell: UITableViewCell {

    static let identifier = "ProgressWillCell"
    ...
    let progressView: ProgressView = {
        ...
        view.hStack.subviews[1].subviews[0].tintColor = .purple
        view.hStack.subviews[1].subviews[1].tintColor = .purple
        return view
    }()
