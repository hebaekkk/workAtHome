...
//    func postEditorPhotoPickerController(_ picker: PostEditorPhotoPickerController,
//                                         didFinishPickingContents contents: [PostContent]?)
//}
//
...
//
//        let dissmissionButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.cancel, target: self, action: #selector(actionDismiss(_:)))
//        self.navigationItem.leftBarButtonItem = dissmissionButton
//
//        let okButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.done, target: self, action: #selector(actionFinish(_:)))
...
//        var pickingContens = [PostContent]()
//        indexPath?.forEach({ (indexPath) in
//            if let content = contents?[indexPath.item] {
//                pickingContens.append(content)
//            }
//        })
//
//        self.delegate?.postEditorPhotoPickerController(self, didFinishPickingContents: pickingContens)
//    }
//
//
//}
...
//            let targetSize = DeviceInfo.Orientation.isPortrait ?
//                CGSize(width: view.frame.width / 3 - 1, height: view.frame.width / 6 - 1) : CGSize(width: view.frame.width / 6 - 1, height: view.frame.width / 6 - 1)
//
